    ...
    <footer className="footer" id="contato">
      <div className="container footer-inner">
        ...
        <div>
          ...
          <a href="https://instagram.com/iateclubebrasileiro" target="_blank" rel="noreferrer">Instagram</a>
          <a href="https://facebook.com/iateclubebrasileiro" target="_blank" rel="noreferrer">Facebook</a>
        </div>
      </div>
